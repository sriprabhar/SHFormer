...
def model_defaults():
    ...
    return dict(
        image_size=150, #320
        #model_channels=128, #orig
        model_channels=32,
        learn_sigma=False,
        #num_res_blocks=2, #orig
        num_res_blocks=1,
...
def training_setting_defaults():
    ...
    return dict(
        ...
        model_save_dir="<model save directory path>"
        resume_checkpoint="",
        #use_fp16=True,
        use_fp16=False, 
...
def test_setting_defaults():
    ...
    return dict(
        ...
        log_interval=1,
        model_save_dir="<model save directory path>" 
        resume_checkpoint="model201000.pt",
        output_dir="directory to store the outputs or predictions"
        #use_fp16=True,
        use_fp16=False,
        debug_mode=False,
